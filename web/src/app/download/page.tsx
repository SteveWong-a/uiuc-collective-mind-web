...
import { IconShield, IconDownload, IconCheck, IconExternal } from "@/components/icons";
    ...
    <div className="min-h-screen bg-[var(--color-paper)] text-[var(--color-ink)] flex flex-col">
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/"
            className="text-[13px] font-[600] text-[var(--color-paper)] bg-[var(--color-ink)] border border-[var(--color-ink)] py-[6px] px-[14px] transition-all hover:opacity-90"
      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-12 w-full">
        <div className="text-center mb-10">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              ...
              className={`w-full sm:w-auto flex items-center justify-center gap-3 px-6 py-3.5 border border-[var(--color-ink)] text-[15px] font-[600] transition-all hover:opacity-90 ${
                platform === "mac"
            ...
            >
              ...
              {platform === "mac" && (
                <span className="text-[11px] bg-[rgba(255,255,255,0.2)] px-2 py-0.5 rounded font-normal font-mono">
                  Your OS
                </span>
              )}
            </a>
            ...
            >
              ...
              {platform === "win" && (
                <span className="text-[11px] bg-[rgba(0,0,0,0.08)] px-2 py-0.5 rounded font-normal font-mono">
                  Your OS
                </span>
              )}
            </a>
        ...
        <div
          className="border border-[var(--color-rule)] p-6 sm:p-8 bg-[var(--color-paper)] mb-12"
        ...
        >
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pb-6 border-b border-[var(--color-rule)]">
            <div>
              <div className="inline-flex items-center gap-2 px-2 py-0.5 bg-[var(--color-wash)] border border-[var(--color-rule)] text-[11px] font-[600] uppercase tracking-wider font-mono mb-2">
                Chrome Extension
              </div>
            ...
            <a
              ...
              download
              className="flex items-center gap-2 px-5 py-2.5 bg-[var(--color-ink)] text-[var(--color-paper)] text-[14px] font-[600] no-underline transition-all hover:opacity-90 shrink-0"
          ...
          <div className="mt-6">
            <h3 className="text-[14px] font-[700] mb-4 uppercase tracking-wider text-[var(--color-muted)] font-mono">
              Installation Guide (under 1 minute)
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-5 gap-3 text-[13px]">
              <div className="p-3.5 bg-[var(--color-wash)] border border-[var(--color-rule)]">
                <div className="font-[700] text-[13px] mb-1.5 text-[var(--color-ink)] font-mono">1. Unzip</div>
                <p className="text-[var(--color-muted)] m-0 leading-relaxed text-[12px]">
                  Download <code>uiuc-collective-mind-extension.zip</code> and extract it into a folder.
                </p>
              </div>

              <div className="p-3.5 bg-[var(--color-wash)] border border-[var(--color-rule)]">
                <div className="font-[700] text-[13px] mb-1.5 text-[var(--color-ink)] font-mono">2. Extensions</div>
                <p className="text-[var(--color-muted)] m-0 leading-relaxed text-[12px]">
                  Navigate to <code className="font-mono bg-[var(--color-paper)] px-1">chrome://extensions</code>.
                </p>
              </div>

              <div className="p-3.5 bg-[var(--color-wash)] border border-[var(--color-rule)]">
                <div className="font-[700] text-[13px] mb-1.5 text-[var(--color-ink)] font-mono">3. Dev Mode</div>
                <p className="text-[var(--color-muted)] m-0 leading-relaxed text-[12px]">
              ...
              <div className="p-3.5 bg-[var(--color-wash)] border border-[var(--color-rule)]">
                <div className="font-[700] text-[13px] mb-1.5 text-[var(--color-ink)] font-mono">4. Load Unpacked</div>
                <p className="text-[var(--color-muted)] m-0 leading-relaxed text-[12px]">
              ...
              <div className="p-3.5 bg-[var(--color-wash)] border border-[var(--color-rule)]">
                <div className="font-[700] text-[13px] mb-1.5 text-[var(--color-ink)] font-mono">5. Sync</div>
                <p className="text-[var(--color-muted)] m-0 leading-relaxed text-[12px]">
                  Log in to Canvas in Chrome, then return to Dashboard and click <strong>Sync</strong>.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Security / Open Source Notice */}
        <div
          className="border border-[var(--color-rule)] p-6 sm:p-8 bg-[var(--color-wash)] mb-12"
          style={{ boxShadow: "0 4px 20px rgba(0,0,0,0.03)" }}
        >
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 border border-[var(--color-rule)] bg-[var(--color-paper)] flex items-center justify-center shrink-0">
              <IconShield className="w-5 h-5 text-[var(--color-ink)]" />
            </div>
            <div>
              <div className="inline-flex items-center gap-2 px-2 py-0.5 bg-[var(--color-paper)] border border-[var(--color-rule)] text-[10px] font-[600] uppercase tracking-wider font-mono mb-2">
        ...
        <div className="mb-12">
          ...
          <div className="border border-[var(--color-rule)] overflow-hidden bg-[var(--color-paper)]" style={{ boxShadow: "0 4px 20px rgba(0,0,0,0.03)" }}>
            <table className="w-full text-left border-collapse text-[14px]">
              <thead>
                <tr className="bg-[var(--color-wash)] border-b border-[var(--color-rule)]">
                  <th className="p-3.5 font-[700] text-[13px] uppercase tracking-wider font-mono text-[var(--color-muted)]">Capability</th>
                  <th className="p-3.5 font-[700] text-center w-40 text-[13px] uppercase tracking-wider font-mono text-[var(--color-ink)]">Desktop App</th>
                  <th className="p-3.5 font-[700] text-center w-40 text-[13px] uppercase tracking-wider font-mono text-[var(--color-muted)]">Web Browser</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[var(--color-rule)]">
                <tr>
                  ...
                  <td className="p-3.5 text-center font-[600] text-[var(--color-ink)]">
                    <span className="inline-flex items-center gap-1.5"><IconCheck className="w-4 h-4 text-[var(--color-green)]" /> Automatic</span>
                  </td>
                  <td className="p-3.5 text-center text-[var(--color-muted)] text-[13px]">Only while tab open</td>
                </tr>
                <tr>
                  <td className="p-3.5">
                  ...
                  <td className="p-3.5 text-center font-[600] text-[var(--color-ink)]">
                    <span className="inline-flex items-center gap-1.5"><IconCheck className="w-4 h-4 text-[var(--color-green)]" /> Built-in</span>
                  </td>
                  <td className="p-3.5 text-center text-[var(--color-muted)] text-[13px]">—</td>
                </tr>
                <tr>
                  <td className="p-3.5">
                  ...
                  <td className="p-3.5 text-center font-[600] text-[var(--color-ink)]">
                    <span className="inline-flex items-center gap-1.5"><IconCheck className="w-4 h-4 text-[var(--color-green)]" /> Yes</span>
                  </td>
                  <td className="p-3.5 text-center text-[var(--color-muted)] text-[13px]">—</td>
                </tr>
                <tr>
                  ...
                  <td className="p-3.5 text-center font-[600] text-[var(--color-ink)]">
                    <span className="inline-flex items-center gap-1.5"><IconCheck className="w-4 h-4 text-[var(--color-green)]" /> Native Cookie Store</span>
                  </td>
                  <td className="p-3.5 text-center text-[var(--color-muted)] text-[13px]">Requires Extension</td>
                </tr>
                <tr>
                  <td className="p-3.5">
                  ...
                  <td className="p-3.5 text-center font-[600] text-[var(--color-ink)]">
                    <span className="inline-flex items-center gap-1.5"><IconCheck className="w-4 h-4 text-[var(--color-green)]" /> 100% Local</span>
                  </td>
                  <td className="p-3.5 text-center text-[var(--color-muted)] text-[13px]">Database + Local</td>
                </tr>
              </tbody>
            </table>
          </div>
